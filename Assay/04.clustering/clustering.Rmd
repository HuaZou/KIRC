...
feature <- fread("../../Result/feature/Autoencoder_Remain_features.csv") 
...
#ggsave("../../Result/figure/cluster/best_K_cluster.pdf", k_index_plot, width = 8, height = 5, dpi = 600)
```
...
ggsave("../../Result/figure/cluster/cluster_k2.pdf", kcluster_plot_list$K2, width = 6, height = 8, dpi = 600)
```

* k=3 clusters
```{r, fig.height=8, fig.width=6}
kcluster_plot_list$K3
ggsave("../../Result/figure/cluster/cluster_k3.pdf", kcluster_plot_list$K3, width = 6, height = 8, dpi = 600)
```

* k=4 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K4
ggsave("../../Result/figure/cluster/cluster_k4.pdf", kcluster_plot_list$K4, width = 6, height = 9, dpi = 600)
```

* k=5 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K5
ggsave("../../Result/figure/cluster/cluster_k5.pdf", kcluster_plot_list$K5, width = 6, height = 10, dpi = 600)
```

* k=6 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K6
ggsave("../../Result/figure/cluster/cluster_k6.pdf", kcluster_plot_list$K6, width = 6, height = 10, dpi = 600)
```


=====================================================================================================
Finally, These 43 features were subjective to K-means clustering, with cluster number K ranging from 2 to 6. Using silhouette index and the Calinski-Harabasz criterion, we found that **K=2** was the optimum with the best scores for both metrics. Further, the survival analysis on the full data shows that the survivals in the two sub-clusters are drastically different (log-rank p-value =7.79e-05).
...
write.csv(phen_new, "../../Result/phenotype/phenotype_cluster.csv", row.names = F)
