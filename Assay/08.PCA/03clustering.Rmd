---
title: "K-means clustering analysis based on PCA"
...
feature <- fread("../../Result/feature/PCA_Remain_features.csv") 
...
ggsave("../../Result/figure/cluster/best_K_cluster_PCA.pdf", k_index_plot, width = 8, height = 5, dpi = 600)
```
...
ggsave("../../Result/figure/cluster/cluster_k2_PCA.pdf", kcluster_plot_list$K2, width = 6, height = 8, dpi = 600)
```

* k=3 clusters
```{r, fig.height=8, fig.width=6}
kcluster_plot_list$K3
ggsave("../../Result/figure/cluster/cluster_k3_PCA.pdf", kcluster_plot_list$K3, width = 6, height = 8, dpi = 600)
```

* k=4 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K4
ggsave("../../Result/figure/cluster/cluster_k4_PCA.pdf", kcluster_plot_list$K4, width = 6, height = 9, dpi = 600)
```

* k=5 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K5
ggsave("../../Result/figure/cluster/cluster_k5_PCA.pdf", kcluster_plot_list$K5, width = 6, height = 10, dpi = 600)
```

* k=6 clusters
```{r, fig.height=10, fig.width=6}
kcluster_plot_list$K6
ggsave("../../Result/figure/cluster/cluster_k6_PCA.pdf", kcluster_plot_list$K6, width = 6, height = 10, dpi = 600)
```
...
write.csv(phen_new, "../../Result/phenotype/phenotype_cluster_PCA.csv", row.names = F)
